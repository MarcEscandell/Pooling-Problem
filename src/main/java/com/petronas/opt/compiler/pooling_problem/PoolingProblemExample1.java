...
public class PoolingProblemExample1 {
    ...
    public static void run(PiecewiseRelaxationScheme scheme) {
        ...
        com.petronas.opt.compiler.pooling_problem.LinearRelaxationDetails.Builder lrDetailsBuilder = new com.petronas.opt.compiler.pooling_problem.LinearRelaxationDetails.Builder(scheme);
        ...
        /*MPConstraint s2HardCons = solver.makeConstraint(8000, 8000, "S2 hard");
        s2HardCons.setCoefficient(s2, 1.0);
        MPConstraint pHardCons = solver.makeConstraint(10000, 12950, "P hard");
        s2HardCons.setCoefficient(p, 1.0);*/
     ...
     * @return
     */
    public static LinearRelaxation getLinearRelaxDetails(com.petronas.opt.compiler.pooling_problem.LinearRelaxationDetails.Builder lrDetailsBuilder) {
